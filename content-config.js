  ...
  pages: {
    drugs: {
      categories: [
        ...
        {id:'muscle-relaxant', title:'Muscle Relaxants', kicker:'NEUROMUSCULAR BLOCKERS', description:'Add your NMBA pearls here.', folder:'assets/drugs/muscle-relaxant', prefix:'muscle-relaxant', max:30}
      ]
    },
    criticalCare: {
      categories: [
