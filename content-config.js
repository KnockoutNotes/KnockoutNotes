  ...
  pages: {
    drugs: {
      categories: [
        ...
        {id:'muscle-relaxants', title:'Muscle Relaxants', kicker:'NEUROMUSCULAR BLOCKERS', description:'Add your NMBA pearls here.', folder:'assets/drugs/muscle-relaxants', prefix:'muscle-relaxant', max:30}
      ]
    },
    criticalCare: {
      categories: [
        {id:'icu-scoring', title:'ICU Scoring Pearls', kicker:'ICU SCORING', description:'SOFA, NEWS2, MEWS, qSOFA and scoring-system recommendations.', files:[{url:'assets/critical-care/icu_scoring_1_of_5.jpg'},{url:'assets/critical-care/icu_scoring_2_of_5.jpg'},{url:'assets/critical-care/icu_scoring_3_of_5.jpg'},{url:'assets/critical-care/icu_scoring_4_of_5.jpg'},{url:'assets/critical-care/icu_scoring_5_of_5.jpg'}]},
    ...
    notes: {
      categories: [
        {id:'cardiology', title:'Cardiology Notes', kicker:'CARDIOLOGY', description:'Image notes and PDFs.', folder:'assets/notes/cardiology', prefix:'cardiology-note', max:30},
